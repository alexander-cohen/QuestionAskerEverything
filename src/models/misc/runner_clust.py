...
all_clust_matrix = None
def load_clusters():
    global all_clust_matrix
...
class ClustPlayer(OptimalPlayer): #ALL ITEMS AND FEATURES WILL BE REFERRED TO BY INDEX
    def __init__(self, clusts):
        ...
        raise Exception("The ClustPlayer class is deprecated.")
...
with open(base_path+"data/all_games_for_experiment.pickle", 'w') as agfe:
